...
//   const { selectedProduct } = useContext(WishlistContext);
//   const navigate = useNavigate();

//   if (!selectedProduct) {
//     // If user lands directly, redirect to homepage or show error
//     navigate("/");
//     return null;
//   }
...
//       <img src={selectedProduct.images[0]} alt={selectedProduct.title} className="w-full max-w-md" />
//       <p className="mt-4">{selectedProduct.description}</p>
//       <p className="mt-2 text-sm text-gray-500">{selectedProduct.additionalComments}</p>
//       {/* ...other fields like dimensions, price etc */}
//     </div>
//   );
// };
