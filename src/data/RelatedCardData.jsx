...
export const cards = [
  {
    ...
    sku: "KSN0054",
    src: blueWeddingCard,
    gallery: [blueWeddingCard, ganeshaWeddingCard, scrollWeddingCard, lavenderVariant],
    description:
  ...
  },
  {
    ...
    gallery: [ganeshaWeddingCard, themeWeddingCard, editableWeddingCard, gatefoldWeddingCard],
  ...
  },
  {
    ...
    gallery: [peacockWeddingCard, ganeshaWeddingCard, traditionalWeddingCard, scrollWeddingCard],
  ...
  },
  {
    ...
    gallery: [themeWeddingCard, blueWeddingCard, scrollWeddingCard, editableWeddingCard],
  ...
  },
  {
    ...
    gallery: [editableWeddingCard, themeWeddingCard, ganeshaWeddingCard, traditionalWeddingCard],
    description:
  ...
  },
  {
    ...
    gallery: [traditionalWeddingCard, peacockWeddingCard, editableWeddingCard, scrollWeddingCard],
    description:
  ...
  },
  {
    ...
    gallery: [scrollWeddingCard, ganeshaWeddingCard, traditionalWeddingCard, gatefoldWeddingCard],
    description:
  ...
  },
  {
    ...
    gallery: [gatefoldWeddingCard, blueWeddingCard, peacockWeddingCard, editableWeddingCard],
    description:
